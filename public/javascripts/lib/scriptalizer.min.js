...
function findElementPos(a) {
    ...
    do {
        c += a.offsetLeft;
        b += a.offsetTop
    } while (a = a.offsetParent);return Array(c, b)
}
...
(function() {
    ...
    if (document.documentElement.getBoundingClientRect) {
        ...
        T.fn.offset = function() {
            ...
            var f = this[0], k = f.offsetParent, l = f, a = f.ownerDocument, c, h = a.documentElement, e = a.body, d = a.defaultView, m = d.getComputedStyle(f, null ), b = f.offsetTop, g = f.offsetLeft;
    ...
    T.offset = {
        initialize: function() {
            ...
            var c = document.body, k = document.createElement("div"), g, h, a, f, b, l, e = c.style.marginTop, d = '<div style="position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;"><div></div></div><table style="position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;" cellpadding="0" cellspacing="0"><tr><td></td></tr></table>';
            b = {
                position: "absolute",
                top: 0,
                left: 0,
